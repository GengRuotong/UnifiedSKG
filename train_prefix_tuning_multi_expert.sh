...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node 2 train.py \
    --run_name mt_multi_prefix_phm_expert8_de_split_xmoe_plus12_new \
    --local_rank -1 \
    --seed 3407 \
    ...
    --output_dir output/T5_base_prefix_tuning/multi_domain_prefix_phm_expert8_de_split_xmoe_plus12 \
    --do_train \
    --do_eval \
    --do_predict \
