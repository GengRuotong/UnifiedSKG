...
CUDA_VISIBLE_DEVICES=0 python train.py \
    --run_name mt_multi_phm_32 \
    --seed 3407 \
    --cfg Salesforce/T5_base_prefix_summary_3domains_upsample2_factorized_phm_32.cfg \
    --pretrained_model_path pretrained_model/chinese_t5_pegasus_base/ \
    --freeze_plm True \
    --data_folder_path data/sample_datas_wo_prefix \
    --output_dir output/T5_base_prefix_tuning/multi_domain_phm_32/ \
    --do_train \
    --do_eval \
    --do_predict \
