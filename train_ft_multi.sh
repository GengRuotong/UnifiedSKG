...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node 2 train.py \
    --run_name mt_multi_5domains_2080Ti \
    --pretrained_model_path pretrained_model/chinese_t5_pegasus_base/ \
    --data_folder_path data/sample_datas_w_prefix_ahead/ \
    --output_dir output/T5_base_ft_w_prefix_5domains/multi_domain \
    --seed 2 \
    --cfg Salesforce/T5_base_finetune_summary_all_domains_upsample2.cfg \
    --do_train \
    --do_eval \
    --do_predict \
