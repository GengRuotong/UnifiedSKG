...
input_folder = "data/sample_datas_wo_prefix/single_domain/"
# ft
output_folder = "output/T5_base_ft_wo_prefix/multi_train_single_test/"
# prefix-tuning
# output_folder = "output/T5_base_prefix_summary/multi_train_single_test/"
...
CUDA_VISIBLE_DEVICES=1 python train.py \
    ...
    --load_weights_from output/T5_base_ft_wo_prefix/multi_domain/checkpoint-15000/pytorch_model.bin \
    --do_predict \
    --num_train_epochs 8 \
