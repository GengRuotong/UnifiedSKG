...
output_folder = "output/T5_base_prefix_tuning_3domains_hswitsh_mid128/single_domain/"
...
CUDA_VISIBLE_DEVICES=1 python train.py \
    ...
    --output_dir %s \
    --seed 2 \
    --cfg Salesforce/T5_base_prefix_summary_3domains_upsample2_prelen30_hswitsh_freeze_plm_mid128.cfg \
    --do_train \
    --do_eval \
    --do_predict \
...
""" %(domain_name + '3domains_hswitsh_mid128', domain_name, input_folder, output_path))