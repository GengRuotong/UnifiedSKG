...
CUDA_VISIBLE_DEVICES=1 python train.py \
    --run_name mt_multi_phm_midlinear \
    --seed 2 \
    --cfg Salesforce/T5_base_prefix_summary_all_domains_upsample5_prelen20_facphm_midlinear.cfg \
    --pretrained_model_path pretrained_model/chinese_t5_pegasus_base/ \
    --freeze_plm True \
    --data_folder_path data/sample_datas_wo_prefix \
    --output_dir output/T5_base_prefix_tuning/multi_domain_phm/ \
    --do_train \
    --do_eval \
    --do_predict \
