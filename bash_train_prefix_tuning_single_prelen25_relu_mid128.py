...
domain_list = ['mt_taxi-yonghu', 'mt_maicai']
input_folder = "data/sample_datas_wo_prefix/"
output_folder = "output/T5_base_prefix_tuning_3domains_relu_mid128_prelen25/single_domain/"
...
""" %(domain_name + '3domains_relu_mid128_prelen25', domain_name, input_folder, output_path))