...
domain_list = ['mt_maoyanyanchu', 'mt_taxi-yonghu']
input_folder = "data/sample_datas_wo_prefix/"
output_folder = "output/T5_base_prefix_tuning_3domains_relu_mid128_seed/single_domain/"
...
""" %(domain_name + '3domains_relu_mid128_seed3407', domain_name, input_folder, output_path + '3407/'))
...
""" %(domain_name + '3domains_relu_mid128_114514', domain_name, input_folder, output_path + '114514/'))